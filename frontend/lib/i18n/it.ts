...
export const it = {
  ...
  creativeBrief: {
    ...
    pageSubtitle:
      "Istruzioni operative per il grafico: galleria Amazon, moduli A+ (MVP: primi tre moduli) e FAQ strutturate. Non è copy marketing per il cliente finale.",
    tabGallery: "Galleria immagini",
    tabAPlus: "A+ Content",
    tabFaq: "FAQ",
    introGallery:
      "Brief per 8 immagini con specifiche comuni in un unico blocco. Linguaggio da art director verso il designer.",
    introAPlus: "Brief per Hero, Focus prodotto e Come funziona (dimensioni fisse). Output strutturato in tre moduli.",
    introFaq: "Cinque domande e risposte in formato strutturato, senza claim inventati.",
    generate: "Genera",
    regenerate: "Rigenera",
    copy: "Copia tutto",
    copyFaq: "Copia FAQ",
    copied: "Copiato",
    copiedFaq: "FAQ copiata",
    saveDraft: "Salva bozza",
    saveProject: "Salva progetto",
    ...
    commonSpecsBanner: "Specifiche comuni galleria",
    emptyArea: "Genera il brief per questa area oppure apri un progetto già salvato.",
    loading: "Generazione in corso…",
    errorGeneric: "Generazione non riuscita. Riprova.",
    openFromListing: "Vai a Brief Creativo",
    parseWarning: "Avviso",
    legacyFallbackHint:
      "Il modello ha restituito testo non strutturato: puoi copiarlo o incollarlo nel riquadro sotto come emergenza.",
    rawAccordionTitle: "Testo grezzo (emergenze)",
    rawAccordionHint:
      "JSON strutturato o testo legacy. Usa «Applica JSON» solo se incolli un oggetto valido per l area attiva.",
    applyGrezzo: "Applica JSON",
    restoreGrezzo: "Ripristina da stato salvato",
    grezzoApplied: "Struttura aggiornata dal JSON.",
    grezzoError: "Impossibile applicare il JSON.",
    labels: {
      gallery: {
        commonSpecs: "Specifiche comuni galleria",
        role: "Ruolo:",
        visualInstructions: "Cosa mostrare visivamente:",
        shortMessage: "Messaggio breve in grafica:",
        communicationAngle: "Angolo di comunicazione:",
        designerInstructions: "Indicazioni per il grafico:",
        mistakesToAvoid: "Errori da evitare:",
        productData: "Dati prodotto da valorizzare:",
      },
      aPlus: {
        dimensions: "Dimensioni:",
        visualObjective: "Obiettivo visivo:",
        whatToShow: "Cosa deve mostrare il designer:",
        suggestedText: "Testo suggerito:",
        layoutGuidance: "Guida layout:",
        elementsToHighlight: "Elementi da evidenziare:",
        mistakesToAvoid: "Errori da evitare:",
        productData: "Dati prodotto da usare:",
      },
      faq: {
        cardTitle: "FAQ",
        question: "Domanda:",
