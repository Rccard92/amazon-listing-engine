...
export const it = {
  ...
  keywordIntelligence: {
    ...
    debugTitle: "Traccia AI dettagliata",
    debugHint: "Sezione tecnica per validare logica, regole e decisioni del motore.",
    forensic: {
    ...
    debugShow: "Mostra dettaglio tecnico",
    debugHide: "Nascondi dettaglio tecnico",
    planConfirmLabel: "Confermo esplicitamente il piano keyword finale",
    ...
    decisions: {
      title: "Decisioni sulle keyword",
      subtitle: "Vista sintetica del piano decisionale del motore keyword.",
      contentKeywords: "KEYWORD DA USARE NEI CONTENUTI",
      coreKeywords: "Core keywords",
      supportKeywords: "Support keywords",
      backendKeywords: "KEYWORD DA USARE NEL BACKEND",
    ...
    finalPlan: {
      title: "Piano keyword finale",
      summaryHint: "Riepilogo approvato usato in downstream da titolo, bullet, descrizione e backend terms.",
      primary: "Keyword primaria finale",
      secondary: "Keyword secondarie prioritarie",
      frontendCore: "Core frontend keywords",
      frontendSupport: "Support frontend keywords",
      backend: "Keyword da tenere per backend",
      backendFinal: "Keyword backend finali consigliate",
      verify: "Keyword da verificare",
      excludedFinal: "Keyword escluse definitivamente",
      empty: "-",
    },
    sections: {
  ...
  listingGeneration: {
    ...
    readinessKwOk: "Almeno una keyword primaria",
