...
export const it = {
  ...
  keywordIntelligence: {
    ...
    decisions: {
      ...
      subtitle: "Raggruppate per decisione operativa prima della generazione.",
      accepted: "Keyword accettate",
      excluded: "Keyword escluse",
      verify: "Keyword da verificare",
      competitor: "Keyword brand competitor",
    ...
    finalPlan: {
      ...
      frontend: "Keyword da usare nel frontend",
      backend: "Keyword da tenere per backend",
      excludedFinal: "Keyword escluse definitivamente",
      impactTitle: "Impatto sulla generazione contenuti",
      impactTitleLabel: "Title",
      impactBulletsDescriptionLabel: "Bullets/Description",
      impactBackendLabel: "Backend keywords",
      empty: "-",
    },
    sections: {
